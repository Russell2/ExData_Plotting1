#######################
## plotAll.R is a program designed to read in from the working directory the text
...
## graph in a file the same working directory with the name plotAll.png. The 
## reason for writihg it may be found in the README.md file found in the same
## repository where you found this R code file plotAll.R
##
## NOTE: The original data for this program was downloaded 8/17/2016 19:00 PDT 
## and placed in the same repository where you found this R code file plotAll.R
...
## 
## All other R code file are derived from this file; clearly.
#######################
...
#dev.off() ## shut that device off and go back to the other one
## OR
