#######################
## plot3.R is a program designed to read in from the working directory the text
...
## graph in a file the same working directory with the name plot3.png. The 
## reason for writihg it may be found in the README.md file found in the same
## repository where you found this R code file plot3.R
##
## NOTE: The original data for this program was downloaded 8/17/2016 19:00 PDT 
## and placed in the same repository where you found this R code file plot3.R
